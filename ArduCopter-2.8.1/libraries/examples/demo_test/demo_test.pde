...
void loop(){
    ...
    // display help
    Serial.println("Press 'a' to test accelerometer.");
    Serial.println("Press 'b' to test barometric pressure.");
    Serial.println("Press 'm' to test magnetometer.");
    Serial.println("Press 'g' to test gyroscope.");
